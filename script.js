...
document.addEventListener("DOMContentLoaded", function () {
    ...
    registrationForm.addEventListener("submit", function (event) {
        ...
        if (
            ...
            errors.push(
                "Username must have at least four characters, with only alphanumeric characters, and include at least two unique characters."
            );
            this.username.focus();
        ...
        if (!valid) {
            ...
            localStorage.setItem(
                username, JSON.stringify({ username, email, password }));
            clearForm(this);
